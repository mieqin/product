...
class LianjiaSpider:
    def __init__(self):
        ...
        self.proxies = {"http":"http://123.206.54.52:8118"}
        self.db = pymysql.connect("localhost","root","mieqin",charset="utf8")
    ...
    def parsePage(self,html):
        ...
        self.wrteTomysql(r_list)

    def wrteTomysql(self,r_list):
        ...
        ins = "insert into housePrice(housename,totalprice) values (%s,%s)"
